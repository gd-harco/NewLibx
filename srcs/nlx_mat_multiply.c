 ...
 * @brief File containing the function to multiply matrices
 * @details This file contains the function to multiply matrices. it is used to create the world matrix by multiplying the translation matrix by the rotation matrix.
 * it is also used to multiply the vector map by the world matrix to get the screen coordinates of the points
 * @author gd-harco
 * @version 0.1
 * @date 2023-04-03
 */
